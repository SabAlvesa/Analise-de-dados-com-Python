...
SELECT
    sub.anos_experiencia_na_area_dados,
    sub.media_experiencia_em_anos
FROM
    (
        SELECT
            anos_experiencia_na_area_dados,
...
WHERE
    sub.media_experiencia_em_anos IS NOT NULL
ORDER BY
    sub.media_experiencia_em_anos;
...
ORDER BY 
    ...
    DROP VIEW IF EXISTS vw_media_salarial_por_faixa;
